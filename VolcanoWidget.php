...
<div id="VW_smallMap" style="clear:left"><div id="VW_mCont" style="width:100%;height:200px;position:relative;margin:0;background:#fff;"><a name="VW_mCont"></a><div style="position:absolute;top:8px;right:28px;height:15px;text-align:right;vertical-align:middle;font:12px Verdana,sans-serif;font-weight:bold">[<a href="#" style="color:#bb202a" onclick="switchFrame(\'VW_smallMap\',\'VW_bigMap\',\'enlarge\',\'small map\',\'100%\',\'200px\',0,-180);return false;"><span id="VW_mSwitch">enlarge</span></a>]</div><iframe id="VW_iframe" width="100%" height="100%" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" src="https://earthquakes.volcanodiscovery.com'.$add.'"></iframe></div></div>
...
<table><tr><td width="33%" valign="top"><h5>Customize your map:</h5>
  ...
  <iframe id="VW_iframe" width="100%" height="100%" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" src="https://earthquakes.volcanodiscovery.com/">
  </iframe>
    
  </div></div>
  </td></tr></table>
  
  <b>Stand-alone URL: <a id="standAlone" href="https://earthquakes.volcanodiscovery.com/" target="_blank">https://earthquakes.volcanodiscovery.com/</a></b><br />
...
function updateCode() {
  ...
  var baseURL = 'https://earthquakes.volcanodiscovery.com';
